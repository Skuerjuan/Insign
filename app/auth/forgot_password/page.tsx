        ...
        <main className={styles.page}>
            ...
            <div className={styles.layout}>
                <div className={styles.monkeyWrap}>
                    <Image className={styles.monkey} src="/mono-abecedario.png" alt="Mono de InSign saludando" width={373} height={498} priority />
                </div>
                ...
                <p className={styles.description}>No te preocupes, escribí tu correo de tu cuenta y te ayudaremos a recuperarla.</p>
                <AuthUIProvider
